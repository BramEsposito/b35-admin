...
function b35_admin_shortcuts_enqueue_modal() {
  if (is_singular('post')) {
    ?>
    <div id="b35-admin-shortcuts-modal" aria-hidden="true" tabindex="-1" style="display:none;position:fixed;background-color:rgba(202, 202, 202, 0.59);place-items:center;top:0;bottom:0;left:0;right:0;">
